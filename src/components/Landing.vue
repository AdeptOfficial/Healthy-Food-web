  ...
  <div class="font-roboto bg-vbg bg-no-repeat bg-cover bg-center bg-fixed">
    ...
    <div class="flex flex-col min-h-screen pt-[104px] mb-16 mx-4 sm:mx-6 lg:mx-8">
      <div class="mt-32 mb-16 h-[75vh]">
        ...
        <h1 class="text-center mb-3 text-2xl leading-none text-slate-900 drop-shadow-xl font-bold">
          Fresh Choice was started by a group of students at the University of Illinois at Chicago (UIC). <br>
          They came together because of one problem they all shared, a lack of healthy eating options on campus. <br> <br>
          Poor eating leads to poor health, which leads to financial difficulty and stress, which leads right back to poor eating. <br>
          The unhealthy eating cycle is a negative cycle seen too often in college students.
        ...
        <!-- <img 
          src="https://firebasestorage.googleapis.com/v0/b/exd-project-254c9.appspot.com/o/VIETNAMESE-SPRING-ROLLS.jpg?alt=media&token=63228416-fb72-48bf-bf09-7f1f6ae1b2fc"
          class="max-w-full max-h-full"
          alt="spring-rolls-img" 
        /> -->
      </div>

      <hr>

      <section class="mt-10 mb-32 text-slate-900 text-center">
      ...
      <section class="mb-32 text-gray-800">
        <div
          class="relative overflow-hidden bg-Spring-rolls"
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 items-center">
                  <div class="mb-10 lg:mb-0">
                    <h2 class="text-2xl font-bold">
                      Keep up with announcements and events!
                      <br>
                      <span class="text-3xl text-blue-800">Subscribe to our email list</span>
                    </h2>
                  </div>
      ...
      <div class="flex mx-auto mb-16 rounded-lg overflow-hidden shadow-lg">
        ...
        <div
          class="flex flex-wrap bg-black w-[24rem] h-[16rem] sm:w-[32rem] divide-y"
        >
          <a
            href="/events"
            class="w-full"
